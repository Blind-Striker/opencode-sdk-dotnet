...
fixtures from source, and the two lanes must not drift. The background-service fixtures are also
always the pinned source: the managed service behind the discovery, stop, and Ensure-reuse live

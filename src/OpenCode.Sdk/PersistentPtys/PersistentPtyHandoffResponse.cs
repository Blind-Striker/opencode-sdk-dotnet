...
/// </summary>
public sealed record PersistentPtyHandoffResponse : OpenCodeResponse
{
    private readonly PersistentPtyHandoff? _handoff;
    /// <summary>
    /// Initializes a success instance of the &apos;PersistentPtyHandoffResponse&apos; envelope.
    /// </summary>
    public PersistentPtyHandoffResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal PersistentPtyHandoffResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

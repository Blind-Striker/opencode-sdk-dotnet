...
/// <summary>
/// Represents the response of the &apos;POST /api/session/{sessionID}/rename&apos; operation.
/// </summary>
public sealed record SessionRenameResponse : OpenCodeResponse
{
    /// <summary>
    /// Initializes a success instance of the &apos;SessionRenameResponse&apos; envelope.
    /// </summary>
    public SessionRenameResponse()
    {
    }

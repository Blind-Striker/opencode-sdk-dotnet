...
/// <summary>
/// Represents the response of the &apos;GET /api/session/{sessionID}/form/{formID}&apos; operation.
/// </summary>
public sealed record SessionFormResponse : OpenCodeResponse
{
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal SessionFormResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

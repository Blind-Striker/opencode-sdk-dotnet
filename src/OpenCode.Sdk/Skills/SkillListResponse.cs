...
/// <summary>
/// Represents the response of the &apos;GET /api/skill&apos; operation.
/// </summary>
public sealed record SkillListResponse : OpenCodeResponse
{
    private readonly IReadOnlyList<SkillInfo>? _skills;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;SkillListResponse&apos; envelope.
    /// </summary>
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal SkillListResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;
    ...
    /// <summary>
    /// Gets the Skills payload; guarded on the error path.
    /// </summary>
    public required IReadOnlyList<SkillInfo> Skills { get => _skills ?? throw new InvalidOperationException("The response is an error; check IsError before accessing Skills."); init => _skills = value; }
    /// <summary>
    ...
    protected override bool PrintMembers(StringBuilder builder)
    {
        ...
        _ = builder.Append("Skills = ").Append(_skills);
        return true;
    }
}

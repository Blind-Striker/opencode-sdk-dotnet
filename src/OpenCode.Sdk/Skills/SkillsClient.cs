...
/// <summary>
/// The &apos;SkillsClient&apos; collection client.
/// </summary>
public class SkillsClient
{
    private readonly Pipeline? _pipeline;
    internal SkillsClient(Pipeline pipeline)
    {
    ...
    /// </summary>
    protected SkillsClient()
    {
    }

    private Pipeline Pipeline => _pipeline ?? throw MockSeam.CreateError("SkillsClient", "Pipeline");

...
/// <summary>
/// Represents the response of the &apos;GET /api/vcs/branch&apos; operation.
/// </summary>
public sealed record VcsBranchListResponse : OpenCodeResponse
{
    private readonly IReadOnlyList<string>? _branches;
    private readonly LocationPublicRef? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;VcsBranchListResponse&apos; envelope.
    /// </summary>
    public VcsBranchListResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal VcsBranchListResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

...
/// <summary>
/// Represents the response of the &apos;POST /api/shell&apos; operation.
/// </summary>
public sealed record ShellCreateResponse : OpenCodeResponse
{
    private readonly ShellInfo? _shell;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;ShellCreateResponse&apos; envelope.
    /// </summary>
    public ShellCreateResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal ShellCreateResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

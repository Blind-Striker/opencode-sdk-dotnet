...
/// <summary>
/// Represents the response of the &apos;GET /api/shell/{id}&apos; operation.
/// </summary>
public sealed record ShellResponse : OpenCodeResponse
{
    private readonly ShellInfo? _shell;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;ShellResponse&apos; envelope.
    /// </summary>

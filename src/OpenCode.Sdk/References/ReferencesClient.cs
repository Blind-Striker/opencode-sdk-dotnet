...
/// <summary>
/// The &apos;ReferencesClient&apos; collection client.
/// </summary>
public class ReferencesClient
{
    private readonly Pipeline? _pipeline;
    internal ReferencesClient(Pipeline pipeline)
    {
    ...
    /// </summary>
    protected ReferencesClient()
    {
    }

    private Pipeline Pipeline => _pipeline ?? throw MockSeam.CreateError("ReferencesClient", "Pipeline");

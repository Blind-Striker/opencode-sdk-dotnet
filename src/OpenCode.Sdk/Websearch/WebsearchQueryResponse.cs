...
/// </summary>
public sealed record WebsearchQueryResponse : OpenCodeResponse
{
    private readonly WebSearchResponse? _query;
    private readonly LocationPublicRef? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;WebsearchQueryResponse&apos; envelope.
    /// </summary>
    public WebsearchQueryResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal WebsearchQueryResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

...
/// <summary>
/// Represents the response of the &apos;GET /api/mcp/resource&apos; operation.
/// </summary>
public sealed record McpResourceCatalogResponse : OpenCodeResponse
{
    private readonly McpResourceCatalog? _resourceCatalog;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;McpResourceCatalogResponse&apos; envelope.
    /// </summary>
    public McpResourceCatalogResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal McpResourceCatalogResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;
    ...
    /// <summary>
    /// Gets the ResourceCatalog payload; guarded on the error path.
    /// </summary>
    public required McpResourceCatalog ResourceCatalog { get => _resourceCatalog ?? throw new InvalidOperationException("The response is an error; check IsError before accessing ResourceCatalog."); init => _resourceCatalog = value; }
    /// <summary>
    ...
    protected override bool PrintMembers(StringBuilder builder)
    {
        ...
        _ = builder.Append("ResourceCatalog = ").Append(_resourceCatalog);
        return true;
    }
}

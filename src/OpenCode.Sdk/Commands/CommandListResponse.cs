...
/// <summary>
/// Represents the response of the &apos;GET /api/command&apos; operation.
/// </summary>
public sealed record CommandListResponse : OpenCodeResponse
{
    private readonly IReadOnlyList<CommandInfo>? _commands;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;CommandListResponse&apos; envelope.
    /// </summary>
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal CommandListResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;
    ...
    /// <summary>
    /// Gets the Commands payload; guarded on the error path.
    /// </summary>
    public required IReadOnlyList<CommandInfo> Commands { get => _commands ?? throw new InvalidOperationException("The response is an error; check IsError before accessing Commands."); init => _commands = value; }
    /// <summary>
    ...
    protected override bool PrintMembers(StringBuilder builder)
    {
        ...
        _ = builder.Append("Commands = ").Append(_commands);
        return true;
    }
}

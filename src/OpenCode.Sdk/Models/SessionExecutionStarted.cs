...
/// <summary>
/// Represents a session execution started value.
/// </summary>
public sealed record SessionExecutionStarted : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.execution.started";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionExecutionStartedDurable Durable { get; init; }
    ...
    public required SessionExecutionStartedData Data { get; init; }
}

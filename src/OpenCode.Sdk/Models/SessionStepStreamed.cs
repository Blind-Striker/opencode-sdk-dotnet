...
/// <summary>
/// Represents a session step streamed value.
/// </summary>
public sealed record SessionStepStreamed : ISessionEventDurable, IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.step.streamed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionStepStreamedDurable Durable { get; init; }

...
public sealed record SessionRevertStaged : ISessionEventDurable
{
    ...
    public string Type => "session.revert.staged";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionRevertStagedDurable Durable { get; init; }
    ...
    public required SessionRevertStagedData Data { get; init; }
}

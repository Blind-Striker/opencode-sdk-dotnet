...
public sealed record SessionInboxEnqueued : ISessionEventDurable
{
    ...
    public string Type => "session.inbox.enqueued";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionInboxEnqueuedDurable Durable { get; init; }
    ...
    public required SessionInboxEnqueuedData Data { get; init; }
}

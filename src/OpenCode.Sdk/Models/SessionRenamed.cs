...
/// <summary>
/// Represents a session renamed value.
/// </summary>
public sealed record SessionRenamed : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.renamed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionRenamedDurable Durable { get; init; }
    ...
    public required SessionRenamedData Data { get; init; }
}

...
/// <summary>
/// Represents a question replied value.
/// </summary>
public sealed record QuestionReplied : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "question.replied";
    ...
    public required QuestionRepliedData Data { get; init; }
}

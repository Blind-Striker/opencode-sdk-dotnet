...
/// <summary>
/// Represents a tui session select value.
/// </summary>
public sealed record TuiSessionSelect : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "tui.session.select";
    ...
    public required TuiSessionSelectData Data { get; init; }
}

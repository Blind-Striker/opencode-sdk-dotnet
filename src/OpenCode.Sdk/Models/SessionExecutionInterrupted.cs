...
public sealed record SessionExecutionInterrupted : ISessionEventDurable
{
    ...
    public string Type => "session.execution.interrupted";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionExecutionInterruptedDurable Durable { get; init; }
    ...
    public required SessionExecutionInterruptedData Data { get; init; }
}

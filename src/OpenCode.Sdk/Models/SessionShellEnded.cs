...
/// <summary>
/// Represents a session shell ended value.
/// </summary>
public sealed record SessionShellEnded : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.shell.ended";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionShellEndedDurable Durable { get; init; }
    ...
    public required SessionShellEndedData Data { get; init; }
}

...
/// <summary>
/// Preserves an unknown mcp status payload.
/// </summary>
[JsonConverter(typeof(UnknownMcpStatusJsonConverter))]
public sealed record UnknownMcpStatus : IMcpStatus
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownMcpStatus(string status, JsonElement payload)
    {

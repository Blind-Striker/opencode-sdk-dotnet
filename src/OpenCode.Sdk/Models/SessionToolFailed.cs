...
/// <summary>
/// Represents a session tool failed value.
/// </summary>
public sealed record SessionToolFailed : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.tool.failed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionToolFailedDurable Durable { get; init; }
    ...
    public required SessionToolFailedData Data { get; init; }
}

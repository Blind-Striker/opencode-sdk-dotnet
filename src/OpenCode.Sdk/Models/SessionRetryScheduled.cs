...
public sealed record SessionRetryScheduled : ISessionEventDurable
{
    ...
    public string Type => "session.retry.scheduled";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionRetryScheduledDurable Durable { get; init; }
    ...
    public required SessionRetryScheduledData Data { get; init; }
}

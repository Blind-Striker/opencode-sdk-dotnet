...
/// <summary>
/// Represents a session shell started value.
/// </summary>
public sealed record SessionShellStarted : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.shell.started";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionShellStartedDurable Durable { get; init; }
    ...
    public required SessionShellStartedData Data { get; init; }
}

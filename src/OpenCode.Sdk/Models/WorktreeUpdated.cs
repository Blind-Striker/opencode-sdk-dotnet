...
/// <summary>
/// Represents a worktree updated value.
/// </summary>
public sealed record WorktreeUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "worktree.updated";
    ...
    public required WorktreeUpdatedData Data { get; init; }
}

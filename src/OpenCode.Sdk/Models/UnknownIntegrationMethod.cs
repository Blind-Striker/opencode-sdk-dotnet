...
/// <summary>
/// Preserves an unknown integration method payload.
/// </summary>
[JsonConverter(typeof(UnknownIntegrationMethodJsonConverter))]
public sealed record UnknownIntegrationMethod : IIntegrationMethod
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownIntegrationMethod(string type, JsonElement payload)
    {

...
/// <summary>
/// Represents a session tool progress value.
/// </summary>
public sealed record SessionToolProgress : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.tool.progress";
    ...
    public required SessionToolProgressData Data { get; init; }
}

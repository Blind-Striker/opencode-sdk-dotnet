...
public sealed record SessionCompactionStarted : ISessionEventDurable
{
    ...
    public string Type => "session.compaction.started";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionCompactionStartedDurable Durable { get; init; }
    ...
    public required SessionCompactionStartedData Data { get; init; }
}

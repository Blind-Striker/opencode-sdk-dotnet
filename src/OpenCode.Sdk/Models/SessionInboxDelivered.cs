...
/// <summary>
/// Represents a session inbox delivered value.
/// </summary>
public sealed record SessionInboxDelivered : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.inbox.delivered";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionInboxDeliveredDurable Durable { get; init; }
    ...
    public required SessionInboxDeliveredData Data { get; init; }
}

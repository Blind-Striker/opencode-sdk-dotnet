...
/// <summary>
/// Preserves an unknown session log item payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionLogItemJsonConverter))]
public sealed record UnknownSessionLogItem : ISessionLogItem
{

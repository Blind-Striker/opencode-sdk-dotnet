...
/// <summary>
/// Represents a session created value.
/// </summary>
public sealed record SessionCreated : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public required SessionCreatedDurable Durable { get; init; }
    ...
    public required SessionCreatedData Data { get; init; }
}

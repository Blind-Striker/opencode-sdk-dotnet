...
/// <summary>
/// Represents a session step ended value.
/// </summary>
public sealed record SessionStepEnded : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.step.ended";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionStepEndedDurable Durable { get; init; }
    ...
    public required SessionStepEndedData Data { get; init; }
}

...
/// <summary>
/// Preserves an unknown reference source payload.
/// </summary>
[JsonConverter(typeof(UnknownReferenceSourceJsonConverter))]
public sealed record UnknownReferenceSource : IReferenceSource
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownReferenceSource(string type, JsonElement payload)
    {

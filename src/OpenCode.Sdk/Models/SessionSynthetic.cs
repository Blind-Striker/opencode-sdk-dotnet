...
/// <summary>
/// Represents a session synthetic value.
/// </summary>
public sealed record SessionSynthetic : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.synthetic";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionSyntheticDurable Durable { get; init; }
    ...
    public required SessionSyntheticData Data { get; init; }
}

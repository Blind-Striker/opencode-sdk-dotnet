...
/// <summary>
/// Preserves an unknown session event durable payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionEventDurableJsonConverter))]
public sealed record UnknownSessionEventDurable : ISessionEventDurable
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionEventDurable(string type, JsonElement payload)
    {

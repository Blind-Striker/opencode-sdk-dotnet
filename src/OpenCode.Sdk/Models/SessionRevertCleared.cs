...
/// <summary>
/// Represents a session revert cleared value.
/// </summary>
public sealed record SessionRevertCleared : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.revert.cleared";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionRevertClearedDurable Durable { get; init; }
    ...
    public required SessionRevertClearedData Data { get; init; }
}

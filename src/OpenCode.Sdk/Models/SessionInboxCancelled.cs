...
public sealed record SessionInboxCancelled : ISessionEventDurable
{
    ...
    public string Type => "session.inbox.cancelled";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionInboxCancelledDurable Durable { get; init; }
    ...
    public required SessionInboxCancelledData Data { get; init; }
}

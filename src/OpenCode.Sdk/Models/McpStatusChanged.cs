...
/// <summary>
/// Represents a mcp status changed value.
/// </summary>
public sealed record McpStatusChanged : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "mcp.status.changed";
    ...
    public required McpStatusChangedData Data { get; init; }
}

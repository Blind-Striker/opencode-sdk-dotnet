...
/// <summary>
/// Represents a credential switched value.
/// </summary>
public sealed record CredentialSwitched : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "credential.switched";
    ...
    public required CredentialSwitchedData Data { get; init; }
}

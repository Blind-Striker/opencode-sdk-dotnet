...
public sealed record McpLocalConfig : IMcp
{
    ...
    /// </summary>
    public override string ToString() => RecordPrinter.Format(nameof(McpLocalConfig), ("Type", Type), ("Command", Command), ("Cwd", Cwd), ("Environment", RecordPrinter.Redact(Environment)), ("Disabled", Disabled), ("Codemode", Codemode), ("Timeout", Timeout), ("Protocol", Protocol));
}

...
/// <summary>
/// Represents a filesystem changed value.
/// </summary>
public sealed record FilesystemChanged : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "filesystem.changed";
    ...
    public required FilesystemChangedData Data { get; init; }
}

...
/// <summary>
/// Preserves an unknown session status payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionStatusJsonConverter))]
public sealed record UnknownSessionStatus : ISessionStatus
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionStatus(string type, JsonElement payload)
    {

...
/// <summary>
/// Represents a session model selected value.
/// </summary>
public sealed record SessionModelSelected : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.model.selected";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionModelSelectedDurable Durable { get; init; }
    ...
    public required SessionModelSelectedData Data { get; init; }
}

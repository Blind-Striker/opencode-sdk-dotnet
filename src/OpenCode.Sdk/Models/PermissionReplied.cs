...
/// <summary>
/// Represents a permission replied value.
/// </summary>
public sealed record PermissionReplied : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "permission.replied";
    ...
    public required PermissionRepliedData Data { get; init; }
}

...
/// <summary>
/// Represents a integration method not found error value.
/// </summary>
public sealed record IntegrationMethodNotFoundError : IOpenCodeError
{
    /// <summary>
    /// Gets the tag value.
    /// </summary>
    [JsonPropertyName("_tag")]
    public string Tag => "IntegrationMethodNotFoundError";

...
/// <summary>
/// Represents a session tool success value.
/// </summary>
public sealed record SessionToolSuccess : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.tool.success";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionToolSuccessDurable Durable { get; init; }
    ...
    public required SessionToolSuccessData Data { get; init; }
}

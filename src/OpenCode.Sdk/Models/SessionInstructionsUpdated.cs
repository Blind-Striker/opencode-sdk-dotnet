...
public sealed record SessionInstructionsUpdated : ISessionEventDurable
{
    ...
    public string Type => "session.instructions.updated";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionInstructionsUpdatedDurable Durable { get; init; }
    ...
    public required SessionInstructionsUpdatedData Data { get; init; }
}

...
/// <summary>
/// Preserves an unknown session fork request boundary payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionForkRequestBoundaryJsonConverter))]
public sealed record UnknownSessionForkRequestBoundary : ISessionForkRequestBoundary
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionForkRequestBoundary(string type, JsonElement payload)
    {

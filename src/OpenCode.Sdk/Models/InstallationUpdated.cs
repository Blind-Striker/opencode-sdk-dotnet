...
/// <summary>
/// Represents a installation updated value.
/// </summary>
public sealed record InstallationUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "installation.updated";
    ...
    public required InstallationUpdatedData Data { get; init; }
}

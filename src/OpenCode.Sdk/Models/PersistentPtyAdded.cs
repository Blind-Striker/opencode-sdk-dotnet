...
/// <summary>
/// Represents a persistent pty added value.
/// </summary>
public sealed record PersistentPtyAdded : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "persistent-pty.added";
    ...
    public required PersistentPtyAddedData Data { get; init; }
}

...
/// <summary>
/// Represents a session tool input ended value.
/// </summary>
public sealed record SessionToolInputEnded : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.tool.input.ended";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionToolInputEndedDurable Durable { get; init; }
    ...
    public required SessionToolInputEndedData Data { get; init; }
}

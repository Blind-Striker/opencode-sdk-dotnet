...
/// <summary>
/// Represents a mcp resources changed value.
/// </summary>
public sealed record McpResourcesChanged : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "mcp.resources.changed";
    ...
    public required McpResourcesChangedData Data { get; init; }
}

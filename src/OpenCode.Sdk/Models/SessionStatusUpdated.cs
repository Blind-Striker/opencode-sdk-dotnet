...
/// <summary>
/// Represents a session status updated value.
/// </summary>
public sealed record SessionStatusUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.status";
    ...
    public required SessionStatusUpdatedData Data { get; init; }
}

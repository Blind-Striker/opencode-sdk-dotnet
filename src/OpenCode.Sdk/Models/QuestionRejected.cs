...
/// <summary>
/// Represents a question rejected value.
/// </summary>
public sealed record QuestionRejected : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "question.rejected";
    ...
    public required QuestionRejectedData Data { get; init; }
}

...
/// <summary>
/// Represents a session inbox delivery changed value.
/// </summary>
public sealed record SessionInboxDeliveryChanged : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.inbox.delivery.changed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionInboxDeliveryChangedDurable Durable { get; init; }
    ...
    public required SessionInboxDeliveryChangedData Data { get; init; }
}

...
/// <summary>
/// Represents a project directories updated value.
/// </summary>
public sealed record ProjectDirectoriesUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "project.directories.updated";
    ...
    public required ProjectDirectoriesUpdatedData Data { get; init; }
}

...
/// <summary>
/// Represents a integration command attempt status complete time value.
/// </summary>
public sealed record IntegrationCommandAttemptStatusCompleteTime : IIntegrationCommandAttemptStatusTime
{
    /// <summary>

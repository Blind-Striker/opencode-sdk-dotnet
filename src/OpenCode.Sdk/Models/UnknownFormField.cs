...
/// <summary>
/// Preserves an unknown form field payload.
/// </summary>
[JsonConverter(typeof(UnknownFormFieldJsonConverter))]
public sealed record UnknownFormField : IFormField
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownFormField(string type, JsonElement payload)
    {

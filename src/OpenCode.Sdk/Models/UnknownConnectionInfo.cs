...
/// <summary>
/// Preserves an unknown connection info payload.
/// </summary>
[JsonConverter(typeof(UnknownConnectionInfoJsonConverter))]
public sealed record UnknownConnectionInfo : IConnectionInfo
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownConnectionInfo(string type, JsonElement payload)
    {

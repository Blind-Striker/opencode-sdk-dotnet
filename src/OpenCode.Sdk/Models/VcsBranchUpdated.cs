...
/// <summary>
/// Represents a vcs branch updated value.
/// </summary>
public sealed record VcsBranchUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "vcs.branch.updated";
    ...
    public required VcsBranchUpdatedData Data { get; init; }
}

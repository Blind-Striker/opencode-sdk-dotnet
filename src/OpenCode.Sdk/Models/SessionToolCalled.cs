...
/// <summary>
/// Represents a session tool called value.
/// </summary>
public sealed record SessionToolCalled : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.tool.called";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionToolCalledDurable Durable { get; init; }
    ...
    public required SessionToolCalledData Data { get; init; }
}

...
/// <summary>
/// Represents a session usage updated value.
/// </summary>
public sealed record SessionUsageUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.usage.updated";
    ...
    public required SessionUsageUpdatedData Data { get; init; }
}

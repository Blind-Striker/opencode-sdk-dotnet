...
public sealed record SessionMessageContentUpdated : ISessionEventDurable, IEvent
{
    ...
    public string Type => "session.message.content.updated";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionMessageContentUpdatedDurable Durable { get; init; }
    ...
    public required SessionMessageContentUpdatedData Data { get; init; }
}

...
/// <summary>
/// Represents a worktree resolved value.
/// </summary>
public sealed record WorktreeResolved : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "worktree.resolved";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required WorktreeResolvedDurable Durable { get; init; }
    ...
    public required WorktreeResolvedData Data { get; init; }
}

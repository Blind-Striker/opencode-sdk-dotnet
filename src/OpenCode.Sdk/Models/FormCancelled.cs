...
/// <summary>
/// Represents a form cancelled value.
/// </summary>
public sealed record FormCancelled : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "form.cancelled";
    ...
    public required FormCancelledData Data { get; init; }
}

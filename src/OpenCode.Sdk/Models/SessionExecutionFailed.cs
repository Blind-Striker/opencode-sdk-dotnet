...
/// <summary>
/// Represents a session execution failed value.
/// </summary>
public sealed record SessionExecutionFailed : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.execution.failed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionExecutionFailedDurable Durable { get; init; }
    ...
    public required SessionExecutionFailedData Data { get; init; }
}

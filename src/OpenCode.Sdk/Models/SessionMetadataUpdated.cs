...
/// <summary>
/// Represents a session metadata updated value.
/// </summary>
public sealed record SessionMetadataUpdated : ISessionEventDurable, IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.metadata.updated";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionMetadataUpdatedDurable Durable { get; init; }
    ...
    public required SessionMetadataUpdatedData Data { get; init; }

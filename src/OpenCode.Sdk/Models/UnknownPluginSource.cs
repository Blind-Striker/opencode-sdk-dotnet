...
/// <summary>
/// Preserves an unknown plugin source payload.
/// </summary>
[JsonConverter(typeof(UnknownPluginSourceJsonConverter))]
public sealed record UnknownPluginSource : IPluginSource
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownPluginSource(string type, JsonElement payload)
    {

...
/// <summary>
/// Preserves an unknown session inbox info payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionInboxInfoJsonConverter))]
public sealed record UnknownSessionInboxInfo : ISessionInboxInfo
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionInboxInfo(string type, JsonElement payload)
    {

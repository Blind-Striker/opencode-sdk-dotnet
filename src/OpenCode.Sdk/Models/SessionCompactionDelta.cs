...
/// <summary>
/// Represents a session compaction delta value.
/// </summary>
public sealed record SessionCompactionDelta : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.compaction.delta";
    ...
    public required SessionCompactionDeltaData Data { get; init; }
}

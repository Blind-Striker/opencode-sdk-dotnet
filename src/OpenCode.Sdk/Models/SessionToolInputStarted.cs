...
public sealed record SessionToolInputStarted : ISessionEventDurable
{
    ...
    public string Type => "session.tool.input.started";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionToolInputStartedDurable Durable { get; init; }
    ...
    public required SessionToolInputStartedData Data { get; init; }
}

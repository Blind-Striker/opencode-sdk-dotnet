...
/// <summary>
/// Represents a permission asked value.
/// </summary>
public sealed record PermissionAsked : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "permission.asked";
    ...
    public required PermissionAskedData Data { get; init; }
}

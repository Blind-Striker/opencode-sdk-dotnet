...
/// <summary>
/// Represents a question asked value.
/// </summary>
public sealed record QuestionAsked : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "question.asked";
    ...
    public required QuestionAskedData Data { get; init; }
}

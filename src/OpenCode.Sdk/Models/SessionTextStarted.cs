...
/// <summary>
/// Represents a session text started value.
/// </summary>
public sealed record SessionTextStarted : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.text.started";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionTextStartedDurable Durable { get; init; }
    ...
    public required SessionTextStartedData Data { get; init; }
}

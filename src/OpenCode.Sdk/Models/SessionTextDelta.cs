...
/// <summary>
/// Represents a session text delta value.
/// </summary>
public sealed record SessionTextDelta : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.text.delta";
    ...
    public required SessionTextDeltaData Data { get; init; }
}

...
/// <summary>
/// Represents a session compaction failed value.
/// </summary>
public sealed record SessionCompactionFailed : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.compaction.failed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionCompactionFailedDurable Durable { get; init; }
    ...
    public required SessionCompactionFailedData Data { get; init; }
}

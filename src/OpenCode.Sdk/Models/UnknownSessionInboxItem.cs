...
/// <summary>
/// Preserves an unknown session inbox item payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionInboxItemJsonConverter))]
public sealed record UnknownSessionInboxItem : ISessionInboxItem
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionInboxItem(string type, JsonElement payload)
    {
    ...
    SessionInboxDelivery? ISessionInboxItem.Delivery => null;
}

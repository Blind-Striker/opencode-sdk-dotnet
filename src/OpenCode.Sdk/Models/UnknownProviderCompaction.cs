...
/// <summary>
/// Preserves an unknown provider compaction payload.
/// </summary>
[JsonConverter(typeof(UnknownProviderCompactionJsonConverter))]
public sealed record UnknownProviderCompaction : IProviderCompaction
{

...
/// <summary>
/// Represents a shell created value.
/// </summary>
public sealed record ShellCreated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "shell.created";
    ...
    public required ShellCreatedData Data { get; init; }
}

...
/// <summary>
/// Represents a session execution succeeded value.
/// </summary>
public sealed record SessionExecutionSucceeded : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.execution.succeeded";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionExecutionSucceededDurable Durable { get; init; }
    ...
    public required SessionExecutionSucceededData Data { get; init; }
}

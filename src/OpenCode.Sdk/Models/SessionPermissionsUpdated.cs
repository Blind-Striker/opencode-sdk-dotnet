...
/// <summary>
/// Represents a session permissions updated value.
/// </summary>
public sealed record SessionPermissionsUpdated : ISessionEventDurable, IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.permissions.updated";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionPermissionsUpdatedDurable Durable { get; init; }
    ...
    public required SessionPermissionsUpdatedData Data { get; init; }

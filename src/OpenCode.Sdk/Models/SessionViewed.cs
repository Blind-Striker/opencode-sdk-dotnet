...
/// <summary>
/// Represents a session viewed value.
/// </summary>
public sealed record SessionViewed : ISessionEventDurable, IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.viewed";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionViewedDurable Durable { get; init; }
    ...
    public required SessionViewedData Data { get; init; }
}

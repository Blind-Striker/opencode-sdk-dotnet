...
/// <summary>
/// Preserves an unknown integration attempt status payload.
/// </summary>
[JsonConverter(typeof(UnknownIntegrationAttemptStatusJsonConverter))]
public sealed record UnknownIntegrationAttemptStatus : IIntegrationAttemptStatus
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownIntegrationAttemptStatus(string status, JsonElement payload)
    {

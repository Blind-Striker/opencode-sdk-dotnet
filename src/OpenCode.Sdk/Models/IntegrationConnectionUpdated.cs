...
/// <summary>
/// Represents a integration connection updated value.
/// </summary>
public sealed record IntegrationConnectionUpdated : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "integration.connection.updated";
    ...
    public required IntegrationConnectionUpdatedData Data { get; init; }
}

...
/// <summary>
/// Represents a session reasoning ended value.
/// </summary>
public sealed record SessionReasoningEnded : ISessionEventDurable
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.reasoning.ended";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionReasoningEndedDurable Durable { get; init; }
    ...
    public required SessionReasoningEndedData Data { get; init; }
}

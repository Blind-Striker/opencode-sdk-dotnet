...
/// <summary>
/// Represents a session permissions value.
/// </summary>
public sealed record SessionPermissions : ISessionEventDurable, IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.permissions";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionPermissionsDurable Durable { get; init; }
    ...
    public required SessionPermissionsData Data { get; init; }

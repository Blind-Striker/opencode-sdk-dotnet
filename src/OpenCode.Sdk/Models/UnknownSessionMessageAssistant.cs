...
/// <summary>
/// Preserves an unknown session message assistant payload.
/// </summary>
[JsonConverter(typeof(UnknownSessionMessageAssistantJsonConverter))]
public sealed record UnknownSessionMessageAssistant : ISessionMessageAssistant
{
    ...
    /// </summary>
    [JsonConstructor]
    public UnknownSessionMessageAssistant(string type, JsonElement payload)
    {

...
public sealed record SessionAgentSelected : ISessionEventDurable
{
    ...
    public string Type => "session.agent.selected";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionAgentSelectedDurable Durable { get; init; }
    ...
    public required SessionAgentSelectedData Data { get; init; }
}

...
/// <summary>
/// Represents a session usage recorded data value.
/// </summary>
public sealed record SessionUsageRecordedData
{
    /// <summary>
    ...
    public required SessionUsageRecordedDataSource Source { get; init; }

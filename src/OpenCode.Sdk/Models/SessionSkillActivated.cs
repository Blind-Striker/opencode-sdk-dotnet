...
public sealed record SessionSkillActivated : ISessionEventDurable
{
    ...
    public string Type => "session.skill.activated";

    /// <summary>
    /// Gets the durable value.
    /// </summary>
    [JsonPropertyName("durable")]
    public required SessionSkillActivatedDurable Durable { get; init; }
    ...
    public required SessionSkillActivatedData Data { get; init; }
}

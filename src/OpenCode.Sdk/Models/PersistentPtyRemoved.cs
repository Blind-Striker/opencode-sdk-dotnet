...
/// <summary>
/// Represents a persistent pty removed value.
/// </summary>
public sealed record PersistentPtyRemoved : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "persistent-pty.removed";
    ...
    public required PersistentPtyRemovedData Data { get; init; }
}

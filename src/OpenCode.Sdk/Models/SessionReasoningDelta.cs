...
/// <summary>
/// Represents a session reasoning delta value.
/// </summary>
public sealed record SessionReasoningDelta : IEvent
{
    /// <summary>
    /// Gets the id value.
    /// </summary>
    ...
    public string Type => "session.reasoning.delta";
    ...
    public required SessionReasoningDeltaData Data { get; init; }
}

...
internal sealed class UnknownOpenCodeErrorJsonConverter : JsonConverter<UnknownOpenCodeError>
{
    public override bool HandleNull => true;

    public override UnknownOpenCodeError Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownOpenCodeError value, JsonSerializerOptions options)
    {

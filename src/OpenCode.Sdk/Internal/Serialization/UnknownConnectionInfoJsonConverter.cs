...
internal sealed class UnknownConnectionInfoJsonConverter : JsonConverter<UnknownConnectionInfo>
{
    public override UnknownConnectionInfo Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException("The ConnectionInfo payload must be a JSON object.");
        }

        if (!payload.TryGetProperty("type", out var markerElement))
        {
            throw new JsonException("The ConnectionInfo payload must contain 'type'.");
        }
    ...
    public override void Write(Utf8JsonWriter writer, UnknownConnectionInfo value, JsonSerializerOptions options)
    {

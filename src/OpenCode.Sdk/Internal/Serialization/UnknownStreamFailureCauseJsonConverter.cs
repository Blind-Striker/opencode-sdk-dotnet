...
internal sealed class UnknownStreamFailureCauseJsonConverter : JsonConverter<UnknownStreamFailureCause>
{
    public override UnknownStreamFailureCause Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownStreamFailureCause value, JsonSerializerOptions options)
    {

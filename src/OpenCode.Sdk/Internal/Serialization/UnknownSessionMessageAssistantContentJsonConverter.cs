...
internal sealed class UnknownSessionMessageAssistantContentJsonConverter : JsonConverter<UnknownSessionMessageAssistantContent>
{
    public override UnknownSessionMessageAssistantContent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownSessionMessageAssistantContent value, JsonSerializerOptions options)
    {

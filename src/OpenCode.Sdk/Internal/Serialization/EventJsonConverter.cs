...
internal sealed class EventJsonConverter : JsonConverter<IEvent>
{
    private static readonly FrozenDictionary<string, Type> TypesByTag = new Dictionary<string, Type>(StringComparer.Ordinal)
    {
        ...
        ["integration.connection.updated"] = typeof(IntegrationConnectionUpdated),
        ...
        ["project.directories.updated"] = typeof(ProjectDirectoriesUpdated),
        ["project.directory.resolved"] = typeof(ProjectDirectoryResolved),
        ["pty.created"] = typeof(PtyCreated),
        ["pty.deleted"] = typeof(PtyDeleted),
        ["pty.exited"] = typeof(PtyExited),
        ["pty.updated"] = typeof(PtyUpdated),
        ["question.asked"] = typeof(QuestionAsked),
        ["question.rejected"] = typeof(QuestionRejected),
        ["question.replied"] = typeof(QuestionReplied),
        ...
        ["session.status"] = typeof(SessionStatus),

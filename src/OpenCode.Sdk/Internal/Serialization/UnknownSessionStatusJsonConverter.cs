...
internal sealed class UnknownSessionStatusJsonConverter : JsonConverter<UnknownSessionStatus>
{
    public override UnknownSessionStatus Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownSessionStatus value, JsonSerializerOptions options)
    {

...
internal sealed class UnknownSessionLogItemJsonConverter : JsonConverter<UnknownSessionLogItem>
{
    public override UnknownSessionLogItem Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownSessionLogItem value, JsonSerializerOptions options)
    {

...
internal sealed class UnknownReferenceSourceJsonConverter : JsonConverter<UnknownReferenceSource>
{
    public override UnknownReferenceSource Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException("The ReferenceSource payload must be a JSON object.");
        }

        if (!payload.TryGetProperty("type", out var markerElement))
        {
            throw new JsonException("The ReferenceSource payload must contain 'type'.");
        }
    ...
    public override void Write(Utf8JsonWriter writer, UnknownReferenceSource value, JsonSerializerOptions options)
    {

...
internal sealed class UnknownFormFieldJsonConverter : JsonConverter<UnknownFormField>
{
    public override UnknownFormField Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, UnknownFormField value, JsonSerializerOptions options)
    {

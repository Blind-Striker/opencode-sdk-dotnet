...
/// <summary>
/// Adapts the &apos;GET /api/integration/{integrationID}&apos; responses onto &apos;IntegrationResponse&apos;.
/// </summary>
internal sealed class IntegrationResponseAdapter : ResponseAdapter<IntegrationResponse>
{
    ...
    /// </summary>
    public static IntegrationResponseAdapter Instance { get; } = new IntegrationResponseAdapter();
    ...
    /// </summary>
    public override IntegrationResponse AdaptSuccess(int status, ReadOnlySpan<byte> utf8Body) => CreateSuccess(status, ReadBarePayload(utf8Body, OpenCodeJsonContext.Default.IntegrationResponseEnvelope));
    /// <summary>
    /// Maps one buffered response onto the typed envelope.
    /// </summary>
    public override IntegrationResponse Adapt(int status, string rawBody)
    {
        ArgumentNullException.ThrowIfNull(rawBody);
        return status switch
        {
            200 => CreateSuccess(status, ReadBarePayload(rawBody, OpenCodeJsonContext.Default.IntegrationResponseEnvelope)),
    ...
    private static IntegrationResponse CreateSuccess(int status, IntegrationResponseEnvelope envelope) => new()
    {
        Status = status,
        Integration = envelope.Data,

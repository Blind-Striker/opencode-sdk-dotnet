...
/// <summary>
/// Adapts the &apos;PATCH /api/credential/{credentialID}&apos; responses onto &apos;CredentialUpdateResponse&apos;.
/// </summary>
internal sealed class CredentialUpdateResponseAdapter : ResponseAdapter<CredentialUpdateResponse>
{
    ...
    private CredentialUpdateResponseAdapter()
    {
    }
    ...
    /// </summary>
    public static CredentialUpdateResponseAdapter Instance { get; } = new CredentialUpdateResponseAdapter();
    ...
    /// </summary>
    public override CredentialUpdateResponse AdaptSuccess(int status, ReadOnlySpan<byte> utf8Body) => new()
    {
        Status = status
    };
    /// <summary>
    ...
    /// </summary>
    public override CredentialUpdateResponse Adapt(int status, string rawBody)
    {
        ArgumentNullException.ThrowIfNull(rawBody);
        return status switch
        {
            204 => new CredentialUpdateResponse
            {
                Status = status
            },
            >= 200 and < 300 => throw StatusVerdictFailures.UndeclaredSuccess(status),
            400 => new CredentialUpdateResponse(status, ReadTolerantError(rawBody, Status400Tags), rawBody),
            401 => new CredentialUpdateResponse(status, ReadTolerantError(rawBody, Status401Tags), rawBody),
            _ => new CredentialUpdateResponse(status, ReadTolerantError(rawBody, null), rawBody)
        };
    }
}

...
/// <summary>
/// Adapts the &apos;DELETE /api/experimental/mcp/{server}&apos; responses onto &apos;ExperimentalMcpRemoveResponse&apos;.
/// </summary>
internal sealed class ExperimentalMcpRemoveResponseAdapter : ResponseAdapter<ExperimentalMcpRemoveResponse>
{
    ...
    /// </summary>
    public static ExperimentalMcpRemoveResponseAdapter Instance { get; } = new ExperimentalMcpRemoveResponseAdapter();
    ...
    /// </summary>
    public override ExperimentalMcpRemoveResponse AdaptSuccess(int status, ReadOnlySpan<byte> utf8Body) => new()
    {
        Status = status
    };
    /// <summary>
    ...
    /// </summary>
    public override ExperimentalMcpRemoveResponse Adapt(int status, string rawBody)
    {
        ArgumentNullException.ThrowIfNull(rawBody);
        return status switch
        {
            204 => new ExperimentalMcpRemoveResponse
            {
                Status = status
            },
            >= 200 and < 300 => throw StatusVerdictFailures.UndeclaredSuccess(status),
            400 => new ExperimentalMcpRemoveResponse(status, ReadTolerantError(rawBody, Status400Tags), rawBody),
            401 => new ExperimentalMcpRemoveResponse(status, ReadTolerantError(rawBody, Status401Tags), rawBody),
            404 => new ExperimentalMcpRemoveResponse(status, ReadTolerantError(rawBody, Status404Tags), rawBody),
            _ => new ExperimentalMcpRemoveResponse(status, ReadTolerantError(rawBody, null), rawBody)
        };
    }
}

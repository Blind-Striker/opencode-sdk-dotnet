...
/// (Effect's cross-spawn spawner); downlevel non-Windows kills the root, whose children the
    ...
    public static bool TryKill(Process process)
    {
        try
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Win32NT)
            {
                ...
                // (Effect's cross-spawn spawner), pinned to its well-known system location.

...
/// <summary>
/// Represents the response of the &apos;GET /api/pty/{ptyID}&apos; operation.
/// </summary>
public sealed record PtyResponse : OpenCodeResponse
{
    private readonly Pty? _pty;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;PtyResponse&apos; envelope.
    /// </summary>
    public PtyResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal PtyResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

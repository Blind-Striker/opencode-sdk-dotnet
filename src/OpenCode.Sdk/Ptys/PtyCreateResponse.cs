...
/// <summary>
/// Represents the response of the &apos;POST /api/pty&apos; operation.
/// </summary>
public sealed record PtyCreateResponse : OpenCodeResponse
{
    private readonly Pty? _pty;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;PtyCreateResponse&apos; envelope.
    /// </summary>
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal PtyCreateResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

...
/// </summary>
public sealed record PtyUpdateResponse : OpenCodeResponse
{
    private readonly Pty? _pty;
    private readonly LocationPublicRef? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;PtyUpdateResponse&apos; envelope.
    /// </summary>
    public PtyUpdateResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal PtyUpdateResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;
    ...
    /// <summary>
    /// Gets the Pty payload; guarded on the error path.
    /// </summary>
    public required Pty Pty { get => _pty ?? throw new InvalidOperationException("The response is an error; check IsError before accessing Pty."); init => _pty = value; }
    /// <summary>
    ...
    protected override bool PrintMembers(StringBuilder builder)
    {
        ...
        _ = builder.Append("Pty = ").Append(_pty);
        return true;
    }
}

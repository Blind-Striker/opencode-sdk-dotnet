...
/// <summary>
/// Represents the response of the &apos;GET /api/fs/find&apos; operation.
/// </summary>
public sealed record FsFindResponse : OpenCodeResponse
{
    private readonly IReadOnlyList<FileSystemEntry>? _entries;
    private readonly LocationInfo? _location;
    /// <summary>
    /// Initializes a success instance of the &apos;FsFindResponse&apos; envelope.
    /// </summary>
    public FsFindResponse()
    {
    }
    ...
    /// </summary>
    [SetsRequiredMembers]
    internal FsFindResponse(int status, IOpenCodeError? error, string? rawBody)
    {
        Status = status;
        IsError = true;
        Error = error;

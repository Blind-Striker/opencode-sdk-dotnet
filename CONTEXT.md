...
**Workspace**:
An upstream core addressing concept retained in some event/log contracts. The 2.0.15 public HTTP
...
are prefixless in 2.0.15; public names carry no protocol-version prefix.
